...
namespace Estudo_NOR22.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public EmpresasController(Estudo_NOR22Context context)
        {
            _context = context;
        }

        // GET: Empresas
        public async Task<IActionResult> Index(string? abreviatura)
        {
            var listagem = await _context.Empresa.Include(x => x.Pais).Select(x => x.Pais.Abreviatura == abreviatura).ToListAsync();
