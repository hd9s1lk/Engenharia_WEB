...
namespace FreqPratica1.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Alterar(string id)
        {
            ...
            TempData["contacto"] = contacto.NickName;
        ...
        public async Task<IActionResult> Alterar(string id, [Bind("Email,NickName,Nome,Amigo")] Contacto contacto)
        {
            ...
            if(contacto.NickName.Length > 4 || contacto.NickName.Length < 3)
            {
                ModelState.AddModelError("NickName", "O NickName deve ter entre 3 e 4 caracteres.");
            }

            if (string.IsNullOrEmpty(contacto.Nome) || string.IsNullOrEmpty(contacto.NickName))
            {
                ModelState.AddModelError("Nome", "O Nome e o NickName são obrigatórios.");
            }
