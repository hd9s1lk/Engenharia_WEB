...
namespace NOR_22.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var nOR_22Context = _context.Empresa.Include(e => e.Pais).OrderBy(e => e.Pais.Nome);
        ...
        {
            ViewData["Pais"] = new SelectList(new[] {"Portugal", "Espanha", "França", "Alemanha" });
            return View();
        }
        ...
        {
            if(empresa.Nome.Length < 5)
            {
                ModelState.AddModelError("Nome", "O nome da empresa deve ter pelo menos 5 caracteres.");
            }
        ...
        // POST: Home/Delete/5
        [HttpPost, ActionName("Apager")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ApagerConfirmed(int id)
        {
            var empresa = await _context.Empresa.FindAsync(id);
            if (empresa != null)
            {
