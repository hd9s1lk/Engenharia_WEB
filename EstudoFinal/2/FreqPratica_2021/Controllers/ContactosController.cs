...
using FreqPratica_2021.Models;

namespace FreqPratica_2021.Controllers
{
    public class ContactosController : Controller
    {
        ...
        {
            var amigos = _context.Contacto.Where(x => x.Amigo == true).Count();
            if (amigos == 0)
            {
                var listagem2 = await _context.Contacto.ToListAsync();
                return View(listagem2);
            } else
            {
                return View(amigos);
            }
        ...
        public async Task<IActionResult> Alterar(string id)
        {
            ...
            TempData["Nome"] = contacto.NickName;
            return View(contacto);
        }
        ...
        public async Task<IActionResult> Alterar(string id, [Bind("Email,NickName,Nome,Amigo")] Contacto contacto)
        {
            ...
            {
                ModelState.AddModelError("NickName", "O NickName deve ter 3 caracteres.");
            }
