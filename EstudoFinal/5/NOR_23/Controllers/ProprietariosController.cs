...
namespace NOR_23.Controllers
{
    public class ProprietariosController : Controller
    {
        ...
        {
            var listagem = await _context.Proprietario
                .Select(p => new ProprietarioVeiculoViewModel
                {
                    Id = p.Id,
                    Nome = p.Nome,
        ...
        public async Task<IActionResult> ordena()
        {
            ...
            else if (ordem != null || ordem == "crescente")
            {
                var listagem = await _context.Proprietario
                .Select(p => new ProprietarioVeiculoViewModel
                {
                ...
                .OrderByDescending(p => p.Nome).ToListAsync();
        ...
        public async Task<IActionResult> Detalhes(int? id)
        {
            ...
            TempData["Prop"] = proprietario?.Nome;
