...
using FreqPratica_2023.Data;
using FreqPratica_2023.Models;

namespace FreqPratica_2023.Controllers
{
    public class BolsasController : Controller
    {
        ...
        public async Task<IActionResult> Adiciona([Bind("Id,Titulo,Area,Duracao,Renumeracao")] BolsaInvestigacao bolsaInvestigacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Titulo,Area,Duracao,Renumeracao")] BolsaInvestigacao bolsaInvestigacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Area,Duracao,Renumeracao")] BolsaInvestigacao bolsaInvestigacao)
        {
