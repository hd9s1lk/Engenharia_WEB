...
namespace Final_REC22.Controllers
{
    public class HomeController : Controller
    {
        private readonly Final_REC22Context _context;

        public HomeController(Final_REC22Context context)
        {
            _context = context;
        }
        ...
        {
            var listagem =  _context.Pais.Select(x => new PaisEmpresaViewModel
            {
                Id = x.Id,
                Nome = x.Nome,
