...
namespace Estudo_Aula5.Controllers
{
    public class BooksController : Controller
    {
        private readonly Estudo_Aula5Context _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public BooksController(Estudo_Aula5Context context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CoverPhoto")] BookViewModel book)
        {
            ...
            {
                ModelState.AddModelError("Cover Photo", "Erro");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CoverPhoto")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
