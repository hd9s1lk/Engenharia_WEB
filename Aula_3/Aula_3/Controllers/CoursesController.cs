...
namespace Aula_3.Controllers
{
    ...
    {
        private readonly Aula_3Context _context;

        public CoursesController(Aula_3Context context)
        {
            _context = context;
        }
        ...
        {
            var aula_3Context = _context.Course.Where(x => x.State).Include(c => c.Category);
            return View(await aula_3Context.ToListAsync());
        }
