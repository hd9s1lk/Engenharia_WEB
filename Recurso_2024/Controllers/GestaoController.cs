...
using Recurso_2024.Data;
using Recurso_2024.Models;

namespace Recurso_2024.Controllers
{
    public class GestaoController : Controller
    {
        ...
        {
            var valido = await _context.RegistoNota.Where(x => x.UserName == "Anonimo").ToListAsync();
        ...
        //[HttpPost]
        //public IActionResult Login(string validar)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        RegistoNota u = _context.RegistoNota.Select(x => x.UserName == "Anonimo").Count();
        //        if (u == null)
        //        {
        ...
        //        else
        //        {
        //            HttpContext.Session.SetString("PorValidar", validar);

        //            return RedirectToAction("Notas", "Gestao");
        //        }
        //    }
        //    return View();
        //}
